		...
		{
			{
				...
				DefaultTableColumn foul_shoot_rate = columnModel.addColumn("罚球率", "foul_shoot_rate");
				foul_shoot_rate.padding = 0;	keywordMap.put(foul_shoot_rate, new String[]{"foul_shoot_rate"});
				
				DefaultTableColumn shoot_rate = columnModel.addColumn("二分率", "shoot_rate");
				shoot_rate.padding = 0;	keywordMap.put(shoot_rate, new String[]{"shoot_rate"});
				
				DefaultTableColumn three_shoot_rate = columnModel.addColumn("三分率", "three_shoot_rate");
