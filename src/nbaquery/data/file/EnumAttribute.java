...
public enum EnumAttribute
{
	...
	MATCH_ID(new EnumTable[]{EnumTable.MATCHES, EnumTable.QUARTER_SCORE, EnumTable.PERFORMANCE}, Integer.class, new boolean[]{true, false, false}),
	MATCH_SEASON(EnumTable.MATCHES, String.class),
	MATCH_DATE(EnumTable.MATCHES, String.class),
	MATCH_HOST_ABBR(EnumTable.MATCHES, String.class),
	MATCH_GUEST_ABBR(EnumTable.MATCHES, String.class),
	MATCH_HOST_SCORE(EnumTable.MATCHES, Integer.class),
	MATCH_GUEST_SCORE(EnumTable.MATCHES, Integer.class),
