...
public class DetailedPanel extends JPanel{
	...
	private void set_player_info(){
		...
		direction_label.setText("��Ա < " + player.get_name());
		direction_label.setFont(new Font("΢���ź�",Font.BOLD, 12));
		...
		String player_team_name = "������ӣ� " + player.get_team();
	...
	private void set_team_info(){
		direction_label = new JLabel();
		direction_label.setText("��� < " + team.get_name());
		direction_label.setFont(new Font("΢���ź�",Font.BOLD, 12));
		direction_label.setForeground(new Color(191, 211, 200));
		direction_label.setBounds(0, 0, 160, 30);
		this.add(direction_label);
	...
	private void set_match_info(){
		...
		direction_label = new JLabel();
		direction_label.setText("���� < " + match.get_season() + " " + match.get_team()[0] + " : " + match.get_team()[1]);
		direction_label.setFont(new Font("΢���ź�",Font.BOLD, 12));
		direction_label.setForeground(new Color(191, 211, 200));
		direction_label.setBounds(0, 0, 160, 30);
		this.add(direction_label);
	...
	private String get_player_text(String[] info){
		...
		player_string += "<b>��Ա������</b> " + info[0];
		player_string += "<br/>";
		player_string += "<b>���±�ţ� </b>" + info[1];
		player_string += "<br/>";
		player_string += "<b>��Աλ�ã�</b> " + info[2];
		player_string += "<br/>";
		player_string += "<b>��Ա��ߣ� </b>" + info[3];
		player_string += "<br/>";
		player_string += "<b>��Ա���أ� </b>" + info[4];
		player_string += "<br/>";
		player_string += "<b>�������ڣ� </b>" + info[5];
		player_string += "<br/>";
		player_string += "<b>���䣺 </b>" + info[6];
		player_string += "<br/>";
		player_string += "<b>���䣺</b> " + info[7];
		player_string += "<br/>";
		player_string += "<b>��ҵѧУ�� </b>" + info[8];
		player_string += "</html>";
	...
	private String get_team_text(){
		...
		team_string += "<b>������</b> " + team_detailed_info[0];
		team_string += "<br/>";
		team_string += "<b>����������</b> " + team_detailed_info[2];
		team_string += "<br/>";
		team_string += "<b>Ͷ���������� </b>" + team_detailed_info[3];
		team_string += "<br/>";
		team_string += "<b>Ͷ�����ִ����� </b>" + team_detailed_info[4];
		team_string += "<br/>";
		team_string += "<b>������������ </b>" + team_detailed_info[5] + " ";
		team_string += "<b>���ֳ������� </b>" + team_detailed_info[6];
		team_string += "<br/>";
		team_string += "<b>������������ </b>" + team_detailed_info[7] + " ";
		team_string += "<b>����������� </b>" + team_detailed_info[8];
		team_string += "<br/>";
		team_string += "<b>������������</b> " + team_detailed_info[9] + " ";
		team_string += "<b>������������ </b>" + team_detailed_info[10] + " ";
		team_string += "<b>�������� </b>" + team_detailed_info[11];
		team_string += "<br/>";
		team_string += "<b>�������� </b>" + team_detailed_info[12];
		team_string += "<br/>";
		team_string += "<b>�������� </b>" + team_detailed_info[13];
		team_string += "<br/>";
		team_string += "<b>��ñ���� </b>" + team_detailed_info[14];
		team_string += "<br/>";
		team_string += "<b>ʧ������ </b>" + team_detailed_info[15];
		team_string += "<br/>";
		team_string += "<b>�������� </b>" + team_detailed_info[16];
		team_string += "<br/>";
		team_string += "<b>�����÷֣� </b>" + team_detailed_info[17];
		team_string += "<br/>";
		team_string += "<b>Ͷ�������ʣ� </b>" + team_detailed_info[18];
		team_string += "<br/>";
		team_string += "<b>���������ʣ� </b>" + team_detailed_info[19];
		team_string += "<br/>";
		team_string += "<b>���������ʣ� </b>" + team_detailed_info[20];
		team_string += "<br/>";
		team_string += "<b>ʤ�ʣ� </b>" + team_detailed_info[21];
		team_string += "<br/>";
		team_string += "<b>�����غϣ� </b>" + team_detailed_info[22];
		team_string += "<br/>";
		team_string += "<b>����Ч�ʣ� </b>" + team_detailed_info[23] + " ";
		team_string += "<b>����Ч�ʣ� </b>" + team_detailed_info[24];
		team_string += "<br/>";
		team_string += "<b>��������Ч�ʣ� </b>" + team_detailed_info[25] + " ";
		team_string += "<b>��������Ч�ʣ� </b>" + team_detailed_info[26];
		team_string += "<br/>";
		team_string += "<b>����Ч�ʣ� </b>" + team_detailed_info[27];
		team_string += "<br/>";
		team_string += "<b>����Ч�ʣ� </b>" + team_detailed_info[28];
		team_string += "</html>";
		return team_string;
	}
	private String get_team_primary_text(){
		String text = "<html>";
		text += "<b>�������ڵأ� </b>" + team_detailed_info[31];
		text += "<br/>";
		text += "<b>������ </b>" + team_detailed_info[32];
		text += "<br/>";
		text += "<b>������ </b>" + team_detailed_info[33];
		text += "<br/>";
		text += "<b>������ </b>" + team_detailed_info[34];
		text += "<br/>";
		text += "<b>����ʱ�䣺 </b>" + team_detailed_info[35];
		text += "</html>";
		return text;
	}
	...
	private String get_match_text(){
		...
		match_string += "<b>��Ա������</b> " + player_detailed_info[0];
		match_string += "<br/>";
		match_string += "<b>���±�ţ� </b>" + player_detailed_info[1];
		match_string += "<br/>";
		match_string += "<b>��Աλ�ã�</b> " + player_detailed_info[2];
		match_string += "<br/>";
		match_string += "<b>��Ա��ߣ� </b>" + player_detailed_info[3];
		match_string += "<br/>";
		match_string += "<b>��Ա���أ� </b>" + player_detailed_info[4];
		match_string += "<br/>";
		match_string += "<b>�������ڣ� </b>" + player_detailed_info[5];
		match_string += "<br/>";
		match_string += "<b>���䣺 </b>" + player_detailed_info[6];
		match_string += "<br/>";
		match_string += "<b>���䣺</b> " + player_detailed_info[7];
		match_string += "<br/>";
		match_string += "<b>��ҵѧУ�� </b>" + player_detailed_info[8];
		match_string += "</html>";
		return match_string;
	}
}
